            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 id="headerMonth" class="text-dark mb-0">Dashboard</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="#"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                    </div>
                    <div class="row">
                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Expenses (This month)</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span id="monthlyExpense">$40,000</span></div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary fw-bold m-0">Expense Overview</h6>
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 id="doughnutHeader" class="text-primary fw-bold m-0">Revenue Sources</h6>
                                    <div class="dropdown no-arrow"><button class="btn btn-link btn-sm dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button"><i class="fas fa-ellipsis-v text-gray-400"></i></button>
                                        <div class="dropdown-menu shadow dropdown-menu-end animated--fade-in">
                                            <p class="text-center dropdown-header">dropdown header:</p><a class="dropdown-item" href="#">&nbsp;Action</a><a class="dropdown-item" href="#">&nbsp;Another action</a>
                                            <div class="dropdown-divider"></div><a class="dropdown-item" href="#">&nbsp;Something else here</a>
                                ...
                                <div class="card-body">
                                    <div class="chart-area"><canvas id="chartDoughnut"></canvas></div>
                                    <div id="doughnutChartLegend" class="text-center small mt-4">
                                        ...
                                        <span class="me-2"><i class="fas fa-circle text-info"></i>&nbsp;Refferal</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        var a=new Date();
        getExpensesForWholeMonth(a.getUTCMonth()+1, a.getUTCFullYear());
        getExpensesForAllMonths(a.getUTCFullYear());
        showAmountOfCategoriesPerMonth(a, a.getUTCFullYear());
        actualizeMonth();
    </script>
</body>
